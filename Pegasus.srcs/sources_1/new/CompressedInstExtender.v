    ...
    case (compressed_inst[`COMPRESSED_ADDRESS_QUADRANT])
        `COMPRESSED_QUADRANT_0: begin
            case(compressed_inst[`COMPRESSED_ADDRESS_FUNC3])
                `COMPRESSED_FUNC3_ADDI4SPN:         extended_inst = {2'b0, compressed_inst[10:7], compressed_inst[12:11], compressed_inst[5:6], 2'b0, `COMPRESSED_ADDR_TWO, `F3_ADD, `COMPRESSED_ADDR_EXTENSION, compressed_inst[`COMPRESSED_ADDRESS_RD_REDUCED], `OPCODE_Arith_I, `NOT_COMPRESSED};
        ...
        `COMPRESSED_QUADRANT_1: begin
            case(compressed_inst[`COMPRESSED_ADDRESS_FUNC3])
                `COMPRESSED_FUNC3_ADDI:             extended_inst = {{7{compressed_inst[12]}}, compressed_inst[4:0], compressed_inst[`COMPRESSED_ADDRESS_RS1], `F3_ADD, compressed_inst[`COMPRESSED_ADDRESS_RD], `OPCODE_Arith_I, `NOT_COMPRESSED };
                ...
                `COMPRESSED_FUNC3_LI:               extended_inst = {{7{compressed_inst[12]}}, compressed_inst[4:0], `COMPRESSED_ADDR_ZERO, `F3_ADD, compressed_inst[`COMPRESSED_ADDRESS_RD], `OPCODE_Arith_I, `NOT_COMPRESSED };
